...
function adprodu($title,$detail){
    ...
    if(move_uploaded_file($_FILES["image"]["tmp_name"],"upload/" . $newFilename)){
        $pic=$newFilename;     
            ...
            $adco= mysqli_query($conn,"INSERT INTO event (title,description,pic,dateadded) VALUES ('$title','$detail','$pic','$dateadded')  ");
                
                    if ($adco) {
                        echo' <div id="mess"><p>Event added successfully</p></div>';
                            
                    } else {
                        echo' <div id="mess" style="background-color:red;"><p>Failed to add Event/p></div>';
                    }
...
function addverse($title,$detail){
    include "db.php";
    ...
    if(move_uploaded_file($_FILES["image"]["tmp_name"],"upload/" . $newFilename)){
        $pic=$newFilename;     
            ...
            $dateadded= date('jS F,Y');
            $adco= mysqli_query($conn,"INSERT INTO verse (vtitle,vdetail,vpic,dateadded) VALUES ('$title','$detail','$pic','$dateadded')  ");
...
function so(){
    ...
    include 'db.php';
    $gefo= mysqli_query($conn,"SELECT * FROM App WHERE id = '1' ");
                ...
                <div class="col-xl-5 col-md-6 col-sm-6 col-12">
                    <ul class="list-inline mb-0 d-flex justify-content-sm-end justify-content-center mr-sm-3 ml-sm-0 mx-3">
                        <li class="list-inline-item  mr-3">
                            <p class="bottom-footer">© '.date("Y"). ' POS <a target="_blank" href="http://www.dollarsitr.com">Designed by Dollarsoft Corporation</a></p>
                        </li>
...
function Events(){
    include 'db.php';
    $vp =mysqli_query($conn,"SELECT * FROM event");

    while ($vip= mysqli_fetch_array($vp)) {

        $id= $vip['id'];
        $bname= $vip['title'];
        $gname = $vip['description'];
        $pic = $vip['pic'];
        
        $date_added = $vip['dateadded'];
