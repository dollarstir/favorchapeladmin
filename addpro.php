                    ...
                    <div class="col-lg-6 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing"   style="margin: auto;">
                        <div class="statbox widget box box-shadow">
                            <div class="widget-header">                                
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                       <center> <u><h4>Add Event</h4></u></center>
                                    </div>                                                      
                                </div>
                            </div>
                            <div class="widget-content widget-content-area">
                                <form class="adprod">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input name="title" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Event title">
                                    </div>


                                    <div class="form-group mb-4">
                                        <label for="exampleFormControlInput1">Browse event Image </label>
                                    ...
                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <textarea name="description" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Detail  of event "></textarea>
                                    </div>
                                    ...
                                    <input type="submit" name="subcus" class="mt-4 mb-4 btn btn-button-7 btn-rounded sub" value="Add Event" style="margin-left:150px;background-color:green !important;">
