...
if (isset($_GET['dollar'])) {
    ...
    if ($_GET['dollar']=="addproduct") {
        ...
        if (empty($title)) {
            ...
            echo' <div id="mess" style="background-color:red;"><p>Please Enter Event Title</p></div>';
        }
        elseif (empty($detail)) {
            echo' <div id="mess" style="background-color:red;"><p>describe your event</p></div>';
        }
        elseif (empty($_FILES['image']['name'])) {
            echo' <div id="mess" style="background-color:red;"><p>Browse event image</p></div>';
        }
        
        else {
           echo adprodu($title,$detail); 
        }
